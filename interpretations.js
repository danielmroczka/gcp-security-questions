window.questionInterpretations = {
  ...
  "96": {
    ...
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "97": {
    "q": "Your organization has implemented synchronization and SAML federation between Cloud Identity and Microsoft Active Directory. You want to reduce the risk of Google Cloud user accounts being compromised. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "98": {
    "q": "You have been tasked with implementing external web application protection against common web application attacks for a public application on Google Cloud. You want to validate these policy changes before they are enforced. What service should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "99": {
    "q": "You are asked to recommend a solution to store and retrieve sensitive configuration data from an application that runs on Compute Engine. Which option should you recommend?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "100": {
    "q": "You need to implement an encryption at-rest strategy that reduces key management complexity for non-sensitive data and protects sensitive data while providing the flexibility of controlling the key residency and rotation schedule. FIPS 140-2 L1 compliance is required for all data types. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "101": {
    "q": "Your company wants to determine what products they can build to help customers improve their credit scores depending on their age range. To achieve this, you need to join user information in the company's banking app with customers' credit score data received from a third party. While using this raw data will allow you to complete this task, it exposes sensitive data, which could be propagated into new systems.<br/>This risk needs to be addressed using de-identification and tokenization with Cloud Data Loss Prevention while maintaining the referential integrity across the database. Which cryptographic token format should you use to meet these requirements?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "102": {
    "q": "An office manager at your small startup company is responsible for matching payments to invoices and creating billing alerts. For compliance reasons, the office manager is only permitted to have the Identity and Access Management (IAM) permissions necessary for these tasks. Which two IAM roles should the office manager have? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "103": {
    "q": "You are designing a new governance model for your organization's secrets that are stored in Secret Manager. Currently, secrets for Production and Non-Production applications are stored and accessed using service accounts. Your proposed solution must:<br/>* Provide granular access to secrets<br/>* Give you control over the rotation schedules for the encryption keys that wrap your secrets<br/>* Maintain environment separation<br/>* Provide ease of management<br/>Which approach should you take?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "104": {
    "q": "You are a security engineer at a finance company. Your organization plans to store data on Google Cloud, but your leadership team is worried about the security of their highly sensitive data. Specifically, your company is concerned about internal Google employees' ability to access your company's data on Google Cloud.<br/>What solution should you propose?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "105": {
    "q": "You want to use the gcloud command-line tool to authenticate using a third-party single sign-on (SSO) SAML identity provider. Which options are necessary to ensure that authentication is supported by the third-party identity provider (IdP)? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "106": {
    "q": "You work for a large organization where each business unit has thousands of users. You need to delegate management of access control permissions to each business unit. You have the following requirements:<br/>* Each business unit manages access controls for their own projects.<br/>* Each business unit manages access control permissions at scale.<br/>* Business units cannot access other business units' projects.<br/>* Users lose their access if they move to a different business unit or leave the company.<br/>* Users and access control permissions are managed by the on-premises directory service.<br/>What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "107": {
    "q": "Your organization recently deployed a new application on Google Kubernetes Engine. You need to deploy a solution to protect the application. The solution has the following requirements:<br/>* Scans must run at least once per week<br/>* Must be able to detect cross-site scripting vulnerabilities<br/>* Must be able to authenticate using Google accounts<br/>Which solution should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "108": {
    "q": "An organization is moving applications to Google Cloud while maintaining a few mission-critical applications on-premises. The organization must transfer the data at a bandwidth of at least 50 Gbps. What should they use to ensure secure continued connectivity between sites?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "109": {
    "q": "Your organization has had a few recent DDoS attacks. You need to authenticate responses to domain name lookups. Which Google Cloud service should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "110": {
    "q": "Your Security team believes that a former employee of your company gained unauthorized access to Google Cloud resources some time in the past 2 months by using a service account key. You need to confirm the unauthorized access and determine the user activity. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "111": {
    "q": "Your company requires the security and network engineering teams to identify all network anomalies within and across VPCs, internal traffic from VMs to VMs, traffic between end locations on the internet and VMs, and traffic between VMs to Google Cloud services in production. Which method should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "112": {
    "q": "Your company has been creating users manually in Cloud Identity to provide access to Google Cloud resources. Due to continued growth of the environment, you want to authorize the Google Cloud Directory Sync (GCDS) instance and integrate it with your on-premises LDAP server to onboard hundreds of users. You are required to:<br/>* Replicate user and group lifecycle changes from the on-premises LDAP server in Cloud Identity.<br/>* Disable any manually created users in Cloud Identity.<br/>You have already configured the LDAP search attributes to include the users and security groups in scope for Google Cloud. What should you do next to complete this solution?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "113": {
    "q": "You are troubleshooting access denied errors between Compute Engine instances connected to a Shared VPC and BigQuery datasets. The datasets reside in a project protected by a VPC Service Controls perimeter. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "114": {
    "q": "You recently joined the networking team supporting your company's Google Cloud implementation. You are tasked with familiarizing yourself with the firewall rules configuration and providing recommendations based on your networking and Google Cloud experience. What product should you recommend to detect firewall rules that are overlapped by attributes from other firewall rules with higher or equal priority?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "115": {
    "q": "The security operations team needs access to the security-related logs for all projects in their organization. They have the following requirements:<br/>* Follow the least privilege model by having only view access to logs.<br/>* Have access to Admin Activity logs.<br/>* Have access to Data Access logs.<br/>* Have access to Access Transparency logs.<br/>Which Identity and Access Management (IAM) role should the security operations team be granted?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "116": {
    "q": "You are exporting application logs to Cloud Storage. You encounter an error message that the log sinks don't support uniform bucket-level access policies. How should you resolve this error?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "117": {
    "q": "You plan to deploy your cloud infrastructure using a CI/CD cluster hosted on Compute Engine. You want to minimize the risk of its credentials being stolen by a third party. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "118": {
    "q": "You need to set up two network segments: one with an untrusted subnet and the other with a trusted subnet. You want to configure a virtual appliance such as a next-generation firewall (NGFW) to inspect all traffic between the two network segments. How should you design the network to inspect the traffic?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "119": {
    "q": "You are a member of your company's security team. You have been asked to reduce your Linux bastion host external attack surface by removing all public IP addresses. Site Reliability Engineers (SREs) require access to the bastion host from public locations so they can access the internal VPC while off-site. How should you enable this access?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "120": {
    "q": "You need to enable VPC Service Controls and allow changes to perimeters in existing environments without preventing access to resources. Which VPC Service Controls mode should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "121": {
    "q": "You manage your organization's Security Operations Center (SOC). You currently monitor and detect network traffic anomalies in your Google Cloud VPCs based on packet header information. However, you want the capability to explore network flows and their payload to aid investigations. Which Google Cloud product should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "122": {
    "q": "Your organization acquired a new workload. The Web and Application (App) servers will be running on Compute Engine in a newly created custom VPC. You are responsible for configuring a secure network communication solution that meets the following requirements: Only allows communication between the Web and App tiers. Enforces consistent network security when autoscaling the Web and App tiers. Prevents Compute Engine Instance Admins from altering network traffic. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "123": {
    "q": "You need to connect your organization's on-premises network with an existing Google Cloud environment that includes one Shared VPC with two subnets named Production and Non-Production. You are required to: Use a private transport link. Configure access to Google Cloud APIs through private API endpoints originating from on-premises environments. Ensure that Google Cloud APIs are only consumed via VPC Service Controls. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "124": {
    "q": "You are working with protected health information (PHI) for an electronic health record system. The privacy officer is concerned that sensitive data is stored in the analytics system. You are tasked with anonymizing the sensitive data in a way that is not reversible. Also, the anonymized data should not preserve the character set and length. Which Google Cloud solution should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "125": {
    "q": "You are setting up a CI/CD pipeline to deploy containerized applications to your production clusters on Google Kubernetes Engine (GKE). You need to prevent containers with known vulnerabilities from being deployed. You have the following requirements for your solution: Must be cloud-native. Must be cost-efficient. Minimize operational overhead. How should you accomplish this? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "126": {
    "q": "Which type of load balancer should you use to maintain client IP by default while using the standard network tier?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "127": {
    "q": "You want to prevent users from accidentally deleting a Shared VPC host project. Which organization-level policy constraint should you enable?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "128": {
    "q": "Users are reporting an outage on your public-facing application that is hosted on Compute Engine. You suspect that a recent change to your firewall rules is responsible. You need to test whether your firewall rules are working properly. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "129": {
    "q": "You are a security administrator at your company. Per Google-recommended best practices, you implemented the domain restricted sharing organization policy to allow only required domains to access your projects. An engineering team is now reporting that users at an external partner outside your organization domain cannot be granted access to the resources in a project. How should you make an exception for your partner's domain while following the stated best practices?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "130": {
    "q": "You plan to use a Google Cloud Armor policy to prevent common attacks such as cross-site scripting (XSS) and SQL injection (SQLi) from reaching your web application's backend. What are two requirements for using Google Cloud Armor security policies? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "131": {
    "q": "You perform a security assessment on a customer architecture and discover that multiple VMs have public IP addresses. After providing a recommendation to remove the public IP addresses, you are told those VMs need to communicate to external sites as part of the customer's typical operations. What should you recommend to reduce the need for public IP addresses in your customer's VMs?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "132": {
    "q": "You are tasked with exporting and auditing security logs for login activity events for Google Cloud console and API calls that modify configurations to Google Cloud resources. Your export must meet the following requirements: Export related logs for all projects in the Google Cloud organization. Export logs in near real-time to an external SIEM. What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "133": {
    "q": "Your company's Chief Information Security Officer (CISO) creates a requirement that business data must be stored in specific locations due to regulatory requirements that affect the company's global expansion plans. After working on the details to implement this requirement, you determine the following: The services in scope are included in the Google Cloud Data Residency Terms. The business data remains within specific locations under the same organization. The folder structure can contain multiple data residency locations. You plan to use the Resource Location Restriction organization policy constraint. At which level in the resource hierarchy should you set the constraint?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "134": {
    "q": "You need to set up a Cloud interconnect connection between your company's on-premises data center and VPC host network. You want to make sure that on-premises applications can only access Google APIs over the Cloud Interconnect and not through the public internet. You are required to only use APIs that are supported by VPC Service Controls to mitigate against exfiltration risk to non-supported APIs. How should you configure the network?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "135": {
    "q": "You need to implement an encryption-at-rest strategy that protects sensitive data and reduces key management complexity for non-sensitive data. Your solution has the following requirements: Schedule key rotation for sensitive data. Control which region the encryption keys for sensitive data are stored in. Minimize the latency to access encryption keys for both sensitive and non-sensitive data. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "136": {
    "q": "Your security team uses encryption keys to ensure confidentiality of user data. You want to establish a process to reduce the impact of a potentially compromised symmetric encryption key in Cloud Key Management Service (Cloud KMS).<br/>Which steps should your team take before an incident occurs? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "137": {
    "q": "Your company's chief information security officer (CISO) is requiring business data to be stored in specific locations due to regulatory requirements that affect the company's global expansion plans. After working on a plan to implement this requirement, you determine the following:<br/>- The services in scope are included in the Google Cloud data residency requirements.<br/>- The business data remains within specific locations under the same organization.<br/>- The folder structure can contain multiple data residency locations.<br/>- The projects are aligned to specific locations.<br/>You plan to use the Resource Location Restriction organization policy constraint with very granular control. At which level in the hierarchy should you set the constraint?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "138": {
    "q": "A database administrator notices malicious activities within their Cloud SQL instance. The database administrator wants to monitor the API calls that read the configuration or metadata of resources. Which logs should the database administrator review?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "139": {
    "q": "You are backing up application logs to a shared Cloud Storage bucket that is accessible to both the administrator and analysts. Analysts should not have access to logs that contain any personally identifiable information (PII). Log files containing PII should be stored in another bucket that is only accessible to the administrator. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "140": {
    "q": "You work for an organization in a regulated industry that has strict data protection requirements. The organization backs up their data in the cloud. To comply with data privacy regulations, this data can only be stored for a specific length of time and must be deleted after this specific period.<br/>You want to automate the compliance with this regulation while minimizing storage costs. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "141": {
    "q": "You have been tasked with configuring Security Command Center for your organization's Google Cloud environment. Your security team needs to receive alerts of potential crypto mining in the organization's compute environment and alerts for common Google Cloud misconfigurations that impact security. Which Security Command Center features should you use to configure these alerts? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "142": {
    "q": "You have noticed an increased number of phishing attacks across your enterprise user accounts. You want to implement the Google 2-Step Verification (2SV) option that uses a cryptographic signature to authenticate a user and verify the URL of the login page. Which Google 2SV option should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "143": {
    "q": "Your organization hosts a financial services application running on Compute Engine instances for a third-party company. The third-party company's servers that will consume the application also run on Compute Engine in a separate Google Cloud organization. You need to configure a secure network connection between the Compute Engine instances. You have the following requirements:<br/>- The network connection must be encrypted.<br/>- The communication between servers must be over private IP addresses.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "144": {
    "q": "Your company's new CEO recently sold two of the company's divisions. Your Director asks you to help migrate the Google Cloud projects associated with those divisions to a new organization node. Which preparation steps are necessary before this migration occurs? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "145": {
    "q": "You are a consultant for an organization that is considering migrating their data from its private cloud to Google Cloud. The organization's compliance team is not familiar with Google Cloud and needs guidance on how compliance requirements will be met on Google Cloud. One specific compliance requirement is for customer data at rest to reside within specific geographic boundaries. Which option should you recommend for the organization to meet their data residency requirements on Google Cloud?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "146": {
    "q": "Your security team wants to reduce the risk of user-managed keys being mismanaged and compromised. To achieve this, you need to prevent developers from creating user-managed service account keys for projects in their organization. How should you enforce this?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "147": {
    "q": "You are responsible for managing your company's identities in Google Cloud. Your company enforces 2-Step Verification (2SV) for all users. You need to reset a user's access, but the user lost their second factor for 2SV. You want to minimize risk. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "148": {
    "q": "Which Google Cloud service should you use to enforce access control policies for applications and resources?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "149": {
    "q": "You want to update your existing VPC Service Controls perimeter with a new access level. You need to avoid breaking the existing perimeter with this change, and ensure the least disruptions to users while minimizing overhead. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "150": {
    "q": "Your organization's Google Cloud VMs are deployed via an instance template that configures them with a public IP address in order to host web services for external users. The VMs reside in a service project that is attached to a host (VPC) project containing one custom Shared VPC for the VMs. You have been asked to reduce the exposure of the VMs to the internet while continuing to service external users. You have already recreated the instance template without a public IP address configuration to launch the managed instance group (MIG). What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "151": {
    "q": "Your privacy team uses crypto-shredding (deleting encryption keys) as a strategy to delete personally identifiable information (PII). You need to implement this practice on Google Cloud while still utilizing the majority of the platform's services and minimizing operational overhead. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "152": {
    "q": "You need to centralize your team's logs for production projects. You want your team to be able to search and analyze the logs using Logs Explorer. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "153": {
    "q": "You need to use Cloud External Key Manager to create an encryption key to encrypt specific BigQuery data at rest in Google Cloud. Which steps should you do first?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "154": {
    "q": "Your company's cloud security policy dictates that VM instances should not have an external IP address. You need to identify the Google Cloud service that will allow VM instances without external IP addresses to connect to the internet to update the VMs. Which service should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "155": {
    "q": "You want to make sure that your organization's Cloud Storage buckets cannot have data publicly available to the internet. You want to enforce this across all Cloud Storage buckets. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "156": {
    "q": "Your company plans to move most of its IT infrastructure to Google Cloud. They want to leverage their existing on-premises Active Directory as an identity provider for Google Cloud. Which two steps should you take to integrate the company's on-premises Active Directory with Google Cloud and configure access management? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "157": {
    "q": "You are in charge of creating a new Google Cloud organization for your company. Which two actions should you take when creating the super administrator accounts? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "158": {
    "q": "You are deploying a web application hosted on Compute Engine. A business requirement mandates that application logs are preserved for 12 years and data is kept within European boundaries. You want to implement a storage solution that minimizes overhead and is cost-effective. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "159": {
    "q": "You discovered that sensitive personally identifiable information (PII) is being ingested to your Google Cloud environment in the daily ETL process from an on-premises environment to your BigQuery datasets. You need to redact this data to obfuscate the PII, but need to re-identify it for data analytics purposes. Which components should you use in your solution? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "160": {
    "q": "You are working with a client that is concerned about control of their encryption keys for sensitive data. The client does not want to store encryption keys at rest in the same cloud service provider (CSP) as the data that the keys are encrypting. Which Google Cloud encryption solutions should you recommend to this client? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "161": {
    "q": "You are implementing data protection by design and in accordance with GDPR requirements. As part of design reviews, you are told that you need to manage the encryption key for a solution that includes workloads for Compute Engine, Google Kubernetes Engine, Cloud Storage, BigQuery, and Pub/Sub. Which option should you choose for this implementation?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "162": {
    "q": "Which Identity-Aware Proxy role should you grant to an Identity and Access Management (IAM) user to access HTTPS resources?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "163": {
    "q": "You need to audit the network segmentation for your Google Cloud footprint. You currently operate Production and Non-Production infrastructure-as-a-service (IaaS) environments. All your VM instances are deployed without any service account customization.<br/>After observing the traffic in your custom network, you notice that all instances can communicate freely - despite tag-based VPC firewall rules in place to segment traffic properly - with a priority of 1000. What are the most likely reasons for this behavior?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "164": {
    "q": "You are creating a new infrastructure CI/CD pipeline to deploy hundreds of ephemeral projects in your Google Cloud organization to enable your users to interact with Google Cloud. You want to restrict the use of the default networks in your organization while following Google-recommended best practices. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "165": {
    "q": "You are a security administrator at your company and are responsible for managing access controls (identification, authentication, and authorization) on Google Cloud. Which Google-recommended best practices should you follow when configuring authentication and authorization? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "166": {
    "q": "You have been tasked with inspecting IP packet data for invalid or malicious content. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "167": {
    "q": "You have the following resource hierarchy. There is an organization policy at each node in the hierarchy as shown. Which load balancer types are denied in VPC A?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "168": {
    "q": "Your security team wants to implement a defense-in-depth approach to protect sensitive data stored in a Cloud Storage bucket. Your team has the following requirements:<br/>- The Cloud Storage bucket in Project A can only be readable from Project B.<br/>- The Cloud Storage bucket in Project A cannot be accessed from outside the network.<br/>- Data in the Cloud Storage bucket cannot be copied to an external Cloud Storage bucket.<br/>What should the security team do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "169": {
    "q": "You need to create a VPC that enables your security team to control network resources such as firewall rules. How should you configure the network to allow for separation of duties for network resources?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "170": {
    "q": "You are onboarding new users into Cloud Identity and discover that some users have created consumer user accounts using the corporate domain name. How should you manage these consumer user accounts with Cloud Identity?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "171": {
    "q": "You have created an OS image that is hardened per your organization's security standards and is being stored in a project managed by the security team. As a Google Cloud administrator, you need to make sure all VMs in your Google Cloud organization can only use that specific OS image while minimizing operational overhead. What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "172": {
    "q": "You're developing the incident response plan for your company. You need to define the access strategy that your DevOps team will use when reviewing and investigating a deployment issue in your Google Cloud environment. There are two main requirements:<br/>- Least-privilege access must be enforced at all times.<br/>- The DevOps team must be able to access the required resources only during the deployment issue.<br/>How should you grant access while following Google-recommended best practices?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "173": {
    "q": "You are working with a client who plans to migrate their data to Google Cloud. You are responsible for recommending an encryption service to manage their encrypted keys. You have the following requirements:<br/>- The master key must be rotated at least once every 45 days.<br/>- The solution that stores the master key must be FIPS 140-2 Level 3 validated.<br/>- The master key must be stored in multiple regions within the US for redundancy.<br/>Which solution meets these requirements?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "174": {
    "q": "You manage your organization's Security Operations Center (SOC). You currently monitor and detect network traffic anomalies in your VPCs based on network logs. However, you want to explore your environment using network payloads and headers. Which Google Cloud product should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "175": {
    "q": "You are consulting with a client that requires end-to-end encryption of application data (including data in transit, data in use, and data at rest) within Google Cloud. Which options should you utilize to accomplish this? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "176": {
    "q": "You need to enforce a security policy in your Google Cloud organization that prevents users from exposing objects in their buckets externally. There are currently no buckets in your organization. Which solution should you implement proactively to achieve this goal with the least operational overhead?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "177": {
    "q": "Your company requires the security and network engineering teams to identify all network anomalies and be able to capture payloads within VPCs. Which method should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "178": {
    "q": "An organization wants to track how bonus compensations have changed over time to identify employee outliers and correct earning disparities. This task must be performed without exposing the sensitive compensation data for any individual and must be reversible to identify the outlier. Which Cloud Data Loss Prevention API technique should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "179": {
  ...
  "180": {
    "q": "Your organization develops software involved in many open source projects and is concerned about software supply chain threats. You need to deliver provenance for the build to demonstrate the software is untampered. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "181": {
    "q": "Your organization operates Virtual Machines (VMs) with only private IPs in the Virtual Private Cloud (VPC) with internet access through Cloud NAT. Everyday, you must patch all VMs with critical OS updates and provide summary reports. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "182": {
    "q": "For compliance reporting purposes, the internal audit department needs you to provide the list of virtual machines (VMs) that have critical operating system (OS) security updates available, but not installed. You must provide this list every six months, and you want to perform this task quickly.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "183": {
    "q": "Your company conducts clinical trials and needs to analyze the results of a recent study that are stored in BigQuery. The interval when the medicine was taken contains start and stop dates. The interval data is critical to the analysis, but specific dates may identify a particular batch and introduce bias. You need to obfuscate the start and end dates for each row and preserve the interval data.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "184": {
    "q": "You have a highly sensitive BigQuery workload that contains personally identifiable information (PII) that you want to ensure is not accessible from the internet. To prevent data exfiltration, only requests from authorized IP addresses are allowed to query your BigQuery tables.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "185": {
    "q": "Your organization is moving virtual machines (VMs) to Google Cloud. You must ensure that operating system images that are used across your projects are trusted and meet your security requirements.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "186": {
    "q": "You have stored company approved compute images in a single Google Cloud project that is used as an image repository. This project is protected with VPC Service Controls and exists in the perimeter along with other projects in your organization. This lets other projects deploy images from the image repository project. A team requires deploying a third-party disk image that is stored in an external Google Cloud organization. You need to grant read access to the disk image so that it can be deployed into the perimeter.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "187": {
    "q": "A service account key has been publicly exposed on multiple public code repositories. After reviewing the logs, you notice that the keys were used to generate short-lived credentials. You need to immediately remove access with the service account.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "188": {
    "q": "A company is using Google Kubernetes Engine (GKE) with container images of a mission-critical application. The company wants to scan the images for known security issues and securely share the report with the security team without exposing them outside Google Cloud.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "189": {
    "q": "Your application is deployed as a highly available, cross-region solution behind a global external HTTP(S) load balancer. You notice significant spikes in traffic from multiple IP addresses, but it is unknown whether the IPs are malicious. You are concerned about your application's availability. You want to limit traffic from these clients over a specified time interval.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "190": {
    "q": "Your organization is using Active Directory and wants to configure Security Assertion Markup Language (SAML). You must set up and enforce single sign-on (SSO) for all users.<br/>What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "191": {
    "q": "Employees at your company use their personal computers to access your organization's Google Cloud console. You need to ensure that users can only access the Google Cloud console from their corporate-issued devices and verify that they have a valid enterprise certificate.\nWhat should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "192": {
    "q": "Your organization is rolling out a new continuous integration and delivery (CI/CD) process to deploy infrastructure and applications in Google Cloud. Many teams will use their own instances of the CI/CD workflow. It will run on Google Kubernetes Engine (GKE). The CI/CD pipelines must be designed to securely access Google Cloud APIs.\nWhat should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "193": {
    "q": "Your organization's Customers must scan and upload the contract and their driver license into a web portal in Cloud Storage. You must remove all personally identifiable information (PII) from files that are older than 12 months. Also, you must archive the anonymized files for retention purposes.\nWhat should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "194": {
    "q": "You plan to synchronize identities to Cloud Identity from a third-party identity provider (IdP). You discovered that some employees used their corporate email address to set up consumer accounts to access Google services. You need to ensure that the organization has control over the configuration, security, and lifecycle of these consumer accounts.\nWhat should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "195": {
    "q": "You are auditing all your Google Cloud resources in the production project. You want to identify all principals who can change firewall rules.\nWhat should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "196": {
    "q": "Your organization previously stored files in Cloud Storage by using Google Managed Encryption Keys (GMEK), but has recently updated the internal policy to require Customer Managed Encryption Keys (CMEK). You need to re-encrypt the files quickly and efficiently with minimal cost.\nWhat should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "197": {
    "q": "You run applications on Cloud Run. You already enabled container analysis for vulnerability scanning. However, you are concerned about the lack of control on the applications that are deployed. You must ensure that only trusted container images are deployed on Cloud Run.\nWhat should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "198": {
    "q": "Your organization has on-premises hosts that need to access Google Cloud APIs. You must enforce private connectivity between these hosts, minimize costs, and optimize for operational efficiency.\nWhat should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "199": {
    "q": "As part of your organization's zero trust strategy, you use Identity-Aware Proxy (IAP) to protect multiple applications. You need to ingest logs into a Security Information and Event Management (SIEM) system so that you are alerted to possible intrusions.\nWhich logs should you analyze?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "200": {
    "q": "Your company must follow industry specific regulations. Therefore, you need to enforce customer-managed encryption keys (CMEK) for all new Cloud Storage resources in the organization called org1.\nWhat command should you execute?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "201": {
    "q": "Your company's Google Cloud organization has about 200 projects and 1,500 virtual machines. There is no uniform strategy for logs and events management, which reduces visibility for your security operations team. You need to design a logs management solution that provides visibility and allows the security team to view the environment's configuration.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "202": {
    "q": "Your Google Cloud organization allows for administrative capabilities to be distributed to each team through provision of a Google Cloud project with Owner role (roles/owner). The organization contains thousands of Google Cloud projects. Security Command Center Premium has surfaced multiple OPEN_MYSQL_PORT findings. You are enforcing the guardrails and need to prevent these types of common misconfigurations.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "203": {
    "q": "Your organization must comply with the regulation to keep instance logging data within Europe. Your workloads will be hosted in the Netherlands in region europe-west4 in a new project. You must configure Cloud Logging to keep your data in the country.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "204": {
    "q": "You are using Security Command Center (SCC) to protect your workloads and receive alerts for suspected security breaches at your company. You need to detect cryptocurrency mining software.\nWhich SCC service should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "205": {
    "q": "You are running applications outside Google Cloud that need access to Google Cloud resources. You are using workload identity federation to grant external identities Identity and Access Management (IAM) roles to eliminate the maintenance and security burden associated with service account keys. You must protect against attempts to spoof another user's identity and gain unauthorized access to Google Cloud resources.\nWhat should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "206": {
    "q": "You manage a BigQuery analytical data warehouse in your organization. You want to keep data for all your customers in a common table while you also restrict query access based on rows and columns permissions. Non-query operations should not be supported.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "207": {
    "q": "Your DevOps team uses Packer to build Compute Engine images by using this process:<br/>1. Create an ephemeral Compute Engine VM.<br/>2. Copy a binary from a Cloud Storage bucket to the VM's file system.<br/>3. Update the VM's package manager.<br/>4. Install external packages from the internet onto the VM.<br/>Your security team just enabled the organizational policy, constraints/compute.vmExternalIpAccess, to restrict the usage of public IP Addresses on VMs. In response, your DevOps team updated their scripts to remove public IP addresses on the Compute Engine VMs; however, the build pipeline is failing due to connectivity issues.<br/>What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "208": {
    "q": "Your organization recently activated the Security Command Center (SCC) standard tier. There are a few Cloud Storage buckets that were accidentally made accessible to the public. You need to investigate the impact of the incident and remediate it.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "209": {
    "q": "Your organization is transitioning to Google Cloud. You want to ensure that only trusted container images are deployed on Google Kubernetes Engine (GKE) clusters in a project. The containers must be deployed from a centrally managed Container Registry and signed by a trusted authority.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "210": {
    "q": "Your company uses Google Cloud and has publicly exposed network assets. You want to discover the assets and perform a security audit on these assets by using a software tool in the least amount of time.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "211": {
    "q": "Your organization wants to be compliant with the General Data Protection Regulation (GDPR) on Google Cloud. You must implement data residency and operational sovereignty in the EU. What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "212": {
    "q": "Your company is moving to Google Cloud. You plan to sync your users first by using Google Cloud Directory Sync (GCDS). Some employees have already created Google Cloud accounts by using their company email addresses that were created outside of GCDS. You must create your users on Cloud Identity. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "213": {
    "q": "Your organization is using GitHub Actions as a continuous integration and delivery (CI/CD) platform. You must enable access to Google Cloud resources from the CI/CD pipelines in the most secure way. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "214": {
    "q": "Your organization processes sensitive health information. You want to ensure that data is encrypted while in use by the virtual machines (VMs). You must create a policy that is enforced across the entire organization. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "215": {
    "q": "You are a Cloud Identity administrator for your organization. In your Google Cloud environment, groups are used to manage user permissions. Each application team has a dedicated group. Your team is responsible for creating these groups and the application teams can manage the team members on their own through the Google Cloud console. You must ensure that the application teams can only add users from within your organization to their groups. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "216": {
    "q": "Your organization wants to be continuously evaluated against CIS Google Cloud Computing Foundations Benchmark v1.3.0 (CIS Google Cloud Foundation 1.3). Some of the controls are irrelevant to your organization and must be disregarded in evaluation. You need to create an automated system or process to ensure that only the relevant controls are evaluated. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "217": {
    "q": "You are routing all your internet facing traffic from Google Cloud through your on-premises internet connection. You want to accomplish this goal securely and with the highest bandwidth possible. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "218": {
    "q": "Your organization uses Google Workspace Enterprise Edition for authentication. You are concerned about employees leaving their laptops unattended for extended periods of time after authenticating into Google Cloud. You must prevent malicious people from using an employee's unattended laptop to modify their environment. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "219": {
    "q": "You are migrating an on-premises data warehouse to BigQuery, Cloud SQL, and Cloud Storage. You need to configure security services in the data warehouse. Your company compliance policies mandate that the data warehouse must: • Protect data at rest with full lifecycle management on cryptographic keys. • Implement a separate key management provider from data management. • Provide visibility into all encryption key requests. What services should be included in the data warehouse implementation? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "220": {
    "q": "You manage one of your organization's Google Cloud projects (Project A). A VPC Service Control (SC) perimeter is blocking API access requests to this project, including Pub/Sub. A resource running under a service account in another project (Project B) needs to collect messages from a Pub/Sub topic in your project. Project B is not included in a VPC SC perimeter. You need to provide access from Project B to the Pub/Sub topic in Project A using the principle of least privilege. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "221": {
  ...
  "222": {
    "q": "Your company recently published a security policy to minimize the usage of service account keys. On-premises Windows-based applications are interacting with Google Cloud APIs. You need to implement Workload Identity Federation (WIF) with your identity provider on-premises. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "223": {
    "q": "After completing a security vulnerability assessment, you learned that cloud administrators leave Google Cloud CLI sessions open for days. You need to reduce the risk of attackers who might exploit these open sessions by setting these sessions to the minimum duration. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "224": {
    "q": "You have numerous private virtual machines on Google Cloud. You occasionally need to manage the servers through Secure Socket Shell (SSH) from a remote location. You want to configure remote access to the servers in a manner that optimizes security and cost efficiency. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "225": {
    "q": "Your organization's record data exists in Cloud Storage. You must retain all record data for at least seven years. This policy must be permanent. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "226": {
    "q": "Your organization wants to protect all workloads that run on Compute Engine VM to ensure that the instances weren't compromised by boot-level or kernel-level malware. Also, you need to ensure that data in use on the VM cannot be read by the underlying host system by using a hardware-based solution. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "227": {
    "q": "You are migrating your users to Google Cloud. There are cookie replay attacks with Google web and Google Cloud CLI SDK sessions on endpoint devices. You need to reduce the risk of these threats. What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "228": {
    "q": "You manage a mission-critical workload for your organization, which is in a highly regulated industry. The workload uses Compute Engine VMs to analyze and process the sensitive data after it is uploaded to Cloud Storage from the endpoint computers. Your compliance team has detected that this workload does not meet the data protection requirements for sensitive data. You need to meet these requirements: - Manage the data encryption key (DEK) outside the Google Cloud boundary. - Maintain full control of encryption keys through a third-party provider. - Encrypt the sensitive data before uploading it to Cloud Storage. - Decrypt the sensitive data during processing in the Compute Engine VMs. - Encrypt the sensitive data in memory while in use in the Compute Engine VMs. What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "229": {
    "q": "Your organization wants to be General Data Protection Regulation (GDPR) compliant. You want to ensure that your DevOps teams can only create Google Cloud resources in the Europe regions. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "230": {
    "q": "For data residency requirements, you want your secrets in Google Clouds Secret Manager to only have payloads in europe-west1 and europe-west4. Your secrets must be highly available in both regions. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "231": {
    "q": "You are migrating an application into the cloud. The application will need to read data from a Cloud Storage bucket. Due to local regulatory requirements, you need to hold the key material used for encryption fully under your control and you require a valid rationale for accessing the key material. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "232": {
    "q": "Your organization uses the top-tier folder to separate application environments (prod and dev). The developers need to see all application development audit logs, but they are not permitted to review production logs. Your security team can review all logs in production and development environments. You must grant Identity and Access Management (IAM) roles at the right resource level for the developers and security team while you ensure least privilege. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "233": {
    "q": "You manage a fleet of virtual machines (VMs) in your organization. You have encountered issues with lack of patching in many VMs. You need to automate regular patching in your VMs and view the patch management data across multiple projects. What should you do? (Choose two.)",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "234": {
    "q": "Your organization uses BigQuery to process highly sensitive, structured datasets. Following the \"need to know\" principle, you need to create the Identity and Access Management (IAM) design to meet the needs of these users: - Business user: must access curated reports. - Data engineer: must administrate the data lifecycle in the platform. - Security operator: must review user activity on the data platform. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "235": {
    "q": "You are setting up a new Cloud Storage bucket in your environment that is encrypted with a customer managed encryption key (CMEK). The CMEK is stored in Cloud Key Management Service (KMS), in project \"prj-a\", and the Cloud Storage bucket will use project \"prj-b\". The key is backed by a Cloud Hardware Security Module (HSM) and resides in the region europe-west3. Your storage bucket will be located in the region europe-west1. When you create the bucket, you cannot access the key, and you need to troubleshoot why. What has caused the access issue?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "236": {
    "q": "You are deploying regulated workloads on Google Cloud. The regulation has data residency and data access requirements. It also requires that support is provided from the same geographical location as where the data resides. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "237": {
    "q": "Your organization wants full control of the keys used to encrypt data at rest in their Google Cloud environments. Keys must be generated and stored outside of Google and integrate with many Google Services including BigQuery. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "238": {
    "q": "Your company is concerned about unauthorized parties gaining access to the Google Cloud environment by using a fake login page. You must implement a solution to protect against person-in-the-middle attacks. Which security measure should you use?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "239": {
    "q": "You control network traffic for a folder in your Google Cloud environment. Your folder includes multiple projects and Virtual Private Cloud (VPC) networks. You want to enforce on the folder level that egress connections are limited only to IP range 10.58.5.0/24 and only from the VPC network \"dev-vpc\". You want to minimize implementation and maintenance effort. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "240": {
    "q": "Your customer has an on-premises Public Key Infrastructure (PKI) with a certificate authority (CA). You need to issue certificates for many HTTP load balancer frontends. The on-premises PKI should be minimally affected due to many manual processes, and the solution needs to scale. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "241": {
  ...
  "242": {
    "q": "Your Google Cloud environment has one organization node, one folder named \"Apps\", and several projects within that folder. The organizational node enforces the constraints/iam.allowedPolicyMemberDomains organization policy, which allows members from the terramearth.com organization. The \"Apps\" folder enforces the constraints/iam.allowedPolicyMemberDomains organization policy, which allows members from the flowlogistic.com organization. It also has the inheritFromParent: false property. You attempt to grant access to a project in the \"Apps\" folder to the user testuser@terramearth.com. What is the result of your action and why?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "243": {
    "q": "An administrative application is running on a virtual machine (VM) in a managed group at port 5601 inside a Virtual Private Cloud (VPC) instance without access to the internet currently. You want to expose the web interface at port 5601 to users and enforce authentication and authorization Google credentials. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "244": {
    "q": "Your company's users access data in a BigQuery table. You want to ensure they can only access the data during working hours. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "245": {
    "q": "You have placed several Compute Engine instances in a private subnet. You want to allow these instances to access Google Cloud services, like Cloud Storage, without traversing the internet. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "246": {
    "q": "Your organization relies heavily on Cloud Run for its containerized applications. You utilize Cloud Build for image creation, Artifact Registry for image storage, and Cloud Run for deployment. You must ensure that containers with vulnerabilities rated above a common vulnerability scoring system (CVSS) score of \"medium\" are not deployed to production. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "247": {
    "q": "You run a web application on top of Cloud Run that is exposed to the internet with an Application Load Balancer. You want to ensure that only privileged users from your organization can access the application. The proposed solution must support browser access with single sign-on. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "248": {
    "q": "During a routine security review, your team discovered a suspicious login attempt to impersonate a highly privileged but regularly used service account by an unknown IP address. You need to effectively investigate in order to respond to this potential security incident. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "249": {
    "q": "Your organization has an operational image classification model running on a managed AI service on Google Cloud. You are in a configuration review with stakeholders and must describe the security responsibilities for the image classification model. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "250": {
    "q": "You are managing data in your organization's Cloud Storage buckets and are required to retain objects. To reduce storage costs, you must automatically downgrade the storage class of objects older than 365 days to Coldline storage. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "251": {
    "q": "Your organization has a centralized identity provider that is used to manage human and machine access. You want to leverage this existing identity management system to enable on-premises applications to access Google Cloud without hard coded credentials. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "252": {
  ...
  "253": {
    "q": "Your organization is building a chatbot that is powered by generative AI to deliver automated conversations with internal employees. You must ensure that no data with personally identifiable information (PII) is communicated through the chatbot. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "254": {
    "q": "Your organization has applications that run in multiple clouds. The applications require access to a Google Cloud resource running in your project. You must use short-lived access credentials to maintain security across the clouds. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "255": {
    "q": "Your organization's financial modeling application is already deployed on Google Cloud. The application processes large amounts of sensitive customer financial data. Application code is old and poorly understood by your current software engineers. Recent threat modeling exercises have highlighted the potential risk of sophisticated side-channel attacks against the application while the application is running. You need to further harden the Google Cloud solution to mitigate the risk of these side-channel attacks, ensuring maximum protection for the confidentiality of financial data during processing, while minimizing application problems. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "256": {
    "q": "Your organization has two VPC Service Controls service perimeters, Perimeter-A and Perimeter-B, in Google Cloud. You want to allow data to be copied from a Cloud Storage bucket in Perimeter-A to another Cloud Storage bucket in Perimeter-B. You must minimize exfiltration risk, only allow required connections, and follow the principle of least privilege. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "257": {
    "q": "You are running code in Google Kubernetes Engine (GKE) containers in Google Cloud that require access to objects stored in a Cloud Storage bucket. You need to securely grant the Pods access to the bucket while minimizing management overhead. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "258": {
    "q": "Your organization is adopting Google Cloud and wants to ensure sensitive resources are only accessible from devices within the internal on-premises corporate network. You must configure Access Context Manager to enforce this requirement. These considerations apply: • The internal network uses IP ranges 10.100.0.0/16 and 192.168.0.0/16. • Some employees work remotely but connect securely through a company-managed virtual private network (VPN). The VPN dynamically allocates IP addresses from the pool 172.16.0.0/20. • Access should be restricted to a specific Google Cloud project that is contained within an existing service perimeter. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "259": {
    "q": "Your team maintains 1PB of sensitive data within BigQuery that contains personally identifiable information (PII). You need to provide access to this dataset to another team within your organization for analysis purposes. You must share the BigQuery dataset with the other team while protecting the PII. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "260": {
    "q": "Your organization uses Google Cloud to process large amounts of location data for analysis and visualization. The location data is potentially sensitive. You must design a solution that allows storing and processing the location data securely, minimizing data exposure risks, and adhering to both regulatory guidelines and your organization's internal data residency policies. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "261": {
    "q": "Your organization utilizes Cloud Run services within multiple projects underneath the non-production folder which requires primarily internal communication. Some services need external access to approved fully qualified domain names (FQDN) while other external traffic must be blocked. Internal applications must not be exposed. You must achieve this granular control with allowlists overriding broader restrictions only for designated VPCs. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "262": {
    "q": "Your organization hosts a sensitive web application in Google Cloud. To protect the web application, you've set up a virtual private cloud (VPC) with dedicated subnets for the application's frontend and backend components. You must implement security controls to restrict incoming traffic, protect against web-based attacks, and monitor internal traffic. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "263": {
    "q": "Your organization relies heavily on virtual machines (VMs) in Compute Engine. Due to team growth and resource demands, VM sprawl is becoming problematic. Maintaining consistent security hardening and timely package updates poses an increasing challenge. You need to centralize VM image management and automate the enforcement of security baselines throughout the virtual machine lifecycle. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "264": {
    "q": "Customers complain about error messages when they access your organization's website. You suspect that the web application firewall rules configured in Cloud Armor are too strict. You want to collect request logs to investigate what triggered the rules and blocked the traffic. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "265": {
    "q": "Your organization must follow the Payment Card Industry Data Security Standard (PCI DSS). To prepare for an audit, you must detect deviations on an infrastructure-as-a-service level in your Google Cloud landing zone. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "266": {
  ...
  "267": {
    "q": "Your organization operates in a highly regulated industry and needs to implement strict controls around temporary access to sensitive Google Cloud resources. You have been using Access Approval to manage this access, but your compliance team has mandated the use of a custom signing key. Additionally, they require that the key be stored in a hardware security module (HSM) located outside Google Cloud. You need to configure Access Approval to use a custom signing key that meets the compliance requirements. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "268": {
    "q": "Your organization has sensitive data stored in BigQuery and Cloud Storage. You need to design a solution that provides granular and flexible control authorization to read data. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "269": {
    "q": "Your organization is using Security Command Center Premium as a central tool to detect and alert on security threats. You also want to alert on suspicious outbound traffic that is targeting domains of known suspicious web services. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "270": {
    "q": "You work for a healthcare provider that is expanding into the cloud to store and process sensitive patient data. You must ensure the chosen Google Cloud configuration meets these strict regulatory requirements: • Data must reside within specific geographic regions. • Certain administrative actions on patient data require explicit approval from designated compliance officers. • Access to patient data must be auditable. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "271": {
    "q": "You work for a multinational organization that has systems deployed across multiple cloud providers, including Google Cloud. Your organization maintains an extensive on-premises security information and event management (SIEM) system. New security compliance regulations require that relevant Google Cloud logs be integrated seamlessly with the existing SIEM to provide a unified view of security events. You need to implement a solution that exports Google Cloud logs to your on-premises SIEM by using a push-based, near real-time approach. You must prioritize fault tolerance, security, and auto scaling capabilities. In particular, you must ensure that if a log delivery fails, logs are re-sent. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "272": {
    "q": "You work for a global company. Due to compliance requirements, certain Compute Engine instances that reside within specific projects must be located exclusively in cloud regions within the European Union (EU). You need to ensure that existing non-compliant workloads are remediated and prevent future Compute Engine instances from being launched in restricted regions. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "273": {
    "q": "You are working with developers to secure custom training jobs running on Vertex AI. For compliance reasons, all supported data types must be encrypted by key materials that reside in the Europe region and are controlled by your organization. The encryption activity must not impact the training operation in Vertex AI. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "274": {
    "q": "Your EU-based organization stores both Personally Identifiable Information (PII) and non-PII data in Cloud Storage buckets across multiple Google Cloud regions. EU data privacy laws require that the PII data must not be stored outside of the EU. To help meet this compliance requirement, you want to detect if Cloud Storage buckets outside of the EU contain healthcare data. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "275": {
  ...
  "276": {
    "q": "You are creating a secure network architecture. You must fully isolate development and production environments, and prevent any network traffic between the two environments. The network team requires that there is only one central entry point to the cloud network from the on-premises environment. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "277": {
    "q": "You work for a large organization that is using Cloud Identity as the identity provider (IdP) on Google Cloud. Your InfoSec team has mandated the enforcement of a strong password with a length between 12 and 16 characters for all users. After configuring this requirement, users are still able to access the Google Cloud console with passwords that are less than 12 characters. You need to fix this problem within the Admin console. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "278": {
    "q": "Your organization is preparing to build business services in Google Cloud for the first time. You must determine where to apply appropriate controls or policies. You must also identify what aspects of your cloud deployment are managed by Google. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "279": {
    "q": "Your organization operates a hybrid cloud environment and has recently deployed a private Artifact Registry repository in Google Cloud. On-premises developers cannot resolve the Artifact Registry hostname and therefore cannot push or pull artifacts. You've verified the following: • Connectivity to Google Cloud is established by Cloud VPN or Cloud Interconnect. • No custom DNS configurations exist on-premises. • There is no route to the internet from the on-premises network. You need to identify the cause and enable the developers to push and pull artifacts. What is likely causing the issue and what should you do to fix the issue?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "280": {
    "q": "Your organization has an application hosted in Cloud Run. You must control access to the application by using Cloud Identity-Aware Proxy (IAP) with these requirements: • Only users from the AppDev group may have access. • Access must be restricted to internal network IP addresses. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "281": {
    "q": "You just implemented a Secure Web Proxy instance on Google Cloud for your organization. You were able to reach the internet when you tested this configuration on your test instance. However, developers cannot access the allowed URLs on the Secure Web Proxy instance from their Linux instance on Google Cloud. You want to solve this problem with developers. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "282": {
    "q": "You have just created a new log bucket to replace the _Default log bucket. You want to route all log entries that are currently routed to the _Default log bucket to this new log bucket, in the most efficient manner. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "283": {
    "q": "Your organization's use of the Google Cloud has grown substantially and there are many different groups using different cloud resources independently. You must identify common misconfigurations and compliance violations across the organization and track findings for remedial action in a dashboard. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "284": {
    "q": "You are responsible for a set of Cloud Functions running on your organization's Google Cloud environment. During the last annual security review, secrets were identified in environment variables of some of these Cloud Functions. You must ensure that secrets are identified in a timely manner. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "285": {
    "q": "Your organization is developing a new SaaS application on Google Cloud. Stringent compliance standards require visibility into privileged account activity, and potentially unauthorized changes and misconfigurations to the application's infrastructure. You need to monitor administrative actions, log changes to IAM roles and permissions, and be able to trace potentially unauthorized configuration changes. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "286": {
    "q": "Your application development team is releasing a new critical feature. To complete their final testing, they requested 10 thousand real transaction records. The new feature includes format checking on the primary account number (PAN) of a credit card. You must support the request and minimize the risk of unintended personally identifiable information (PII) exposure. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "287": {
    "q": "You work for a banking organization. You are migrating sensitive customer data to Google Cloud that is currently encrypted at rest while on-premises. There are strict regulatory requirements when moving sensitive data to the cloud. Independent of the cloud service provider, you must be able to audit key usage and be able to deny certain types of decrypt requests. You must choose an encryption strategy that will ensure robust security and compliance with the regulations. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "288": {
    "q": "Your organization is developing an application that will have both corporate and public end-users. You want to centrally manage those customers' identities and authorizations. Corporate end users must access the application by using their corporate user and domain name. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "289": {
    "q": "You work for an organization that handles sensitive customer data. You must secure a series of Google Cloud Storage buckets housing this data and meet these requirements:<br/>\n- Multiple teams need varying access levels (some read-only, some read-write).<br/>\n- Data must be protected in storage and at rest.<br/>\n- It's critical to track file changes and audit access for compliance purposes.<br/>\n- For compliance purposes, the organization must have control over the encryption keys.",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "290": {
    "q": "You are implementing communications restrictions for specific services in your Google Cloud organization. Your data analytics team works in a dedicated folder. You need to ensure that access to BigQuery is controlled for that folder and its projects. The data analytics team must be able to control the restrictions only at the folder level. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "291": {
    "q": "Your organization is using a third-party identity and authentication provider to centrally manage users. You want to use this identity provider to grant access to the Google Cloud console without syncing identities to Google Cloud. Users should receive permissions based on attributes. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "292": {
    "q": "You are implementing a new web application on Google Cloud that will be accessed from your on-premises network. To provide protection from threats like malware, you must implement transport layer security (TLS) interception for incoming traffic to your application. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "293": {
    "q": "Your organization has hired a small, temporary partner team for 18 months. The temporary team will work alongside your DevOps team to develop your organization's application that is hosted on Google Cloud. You must give the temporary partner team access to your application's resources on Google Cloud and ensure that partner employees lose access if they are removed from their employer's organization. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "294": {
    "q": "Your organization has an internet-facing application behind a load balancer. Your regulators require end-to-end encryption of user login credentials. You must implement this requirement. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "295": {
    "q": "Your organization heavily utilizes serverless applications while prioritizing security best practices. You are responsible for enforcing image provenance and compliance with security standards before deployment. You leverage Cloud Build as your continuous integration and continuous deployment (CI/CD) tool for building container images. You must configure Binary Authorization to ensure that only images built by your Cloud Build pipeline are deployed and that the images pass security standard compliance checks. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "296": {
    "q": "Your organization operates in a highly regulated industry and uses multiple Google Cloud services. You need to identify potential risks to regulatory compliance. Which situation introduces the greatest risk?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "297": {
    "q": "Your multinational organization is undergoing rapid expansion within Google Cloud. New teams and projects are added frequently. You are concerned about the potential for inconsistent security policy application and permission sprawl across the organization. You must enforce consistent standards while maintaining the autonomy of regional teams. You need to design a strategy to effectively manage IAM and organization policies at scale, ensuring security and administrative efficiency. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "298": {
    "q": "A security audit uncovered several inconsistencies in your project's Identity and Access Management (IAM) configuration. Some service accounts have overly permissive roles, and a few external collaborators have more access than necessary. You need to gain detailed visibility into changes to IAM policies, user activity, service account behavior, and access to sensitive projects. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "299": {
    "q": "You manage multiple internal-only applications that are hosted within different Google Cloud projects. You are deploying a new application that requires external internet access. To maintain security, you want to clearly separate this new application from internal systems. Your solution must have effective security isolation for the new externally-facing application. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "300": {
    "q": "You work for an ecommerce company that stores sensitive customer data across multiple Google Cloud regions. The development team has built a new 3-tier application to process orders and must integrate the application into the production environment. You must design the network architecture to ensure strong security boundaries and isolation for the new application, facilitate secure remote maintenance by authorized third-party vendors, and follow the principle of least privilege. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "301": {
    "q": "Your organization is implementing separation of duties in a Google Cloud project. A group of developers must deploy new code, but cannot have permission to change network firewall rules. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "302": {
    "q": "You manage a Google Cloud organization with many projects located in various regions around the world. The projects are protected by the same Access Context Manager access policy. You created a new folder that will host two projects that process protected health information (PHI) for US-based customers. The two projects will be separately managed and require stricter protections. You are setting up the VPC Service Controls configuration for the new folder. You must ensure that only US-based personnel can access these projects and restrict Google Cloud API access to only BigQuery and Cloud Storage within these projects. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "303": {
    "q": "There is a threat actor that is targeting organizations like yours. Attacks are always initiated from a known IP address range. You want to deny-list those IPs for your website, which is exposed to the internet through an Application Load Balancer. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "304": {
  ...
  "305": {
    "q": "Your organization is using Vertex AI Workbench Instances. You must ensure that newly deployed Instances are automatically kept up-to-date and that users cannot accidentally alter settings in the operating system. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "306": {
    "q": "You must ensure that the keys used for at-rest encryption of your data are compliant with your organization's security controls. One security control mandates that keys get rotated every 90 days. You must implement an effective detection strategy to validate if keys are rotated as required. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "307": {
    "q": "Your organization is developing a sophisticated machine learning (ML) model to predict customer behavior for targeted marketing campaigns. The BigQuery dataset used for training includes sensitive personal information. You must design the security controls around the AI/ML pipeline. Data privacy must be maintained throughout the model's lifecycle and you must ensure that personal data is not used in the training process. Additionally, you must restrict access to the dataset to an authorized subset of people only. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "308": {
    "q": "Your organization wants to publish yearly reports of your website usage analytics. You must ensure that no data with personally identifiable information (PII) is published by using the Cloud Data Loss Prevention (Cloud DLP) API. Data integrity must be preserved. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "309": {
    "q": "Your development team is launching a new application. The new application has a microservices architecture on Compute Engine instances and serverless components, including Cloud Functions. This application will process financial transactions that require temporary, highly sensitive data in memory. You need to secure data in use during computations with a focus on minimizing the risk of unauthorized access to memory for this financial application. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "310": {
    "q": "You work for a financial organization in a highly regulated industry that is subject to active regulatory compliance. To meet compliance requirements, you need to continuously maintain a specific set of configurations, data residency, organizational policies, and personnel data access controls. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "311": {
    "q": "Your organization is worried about recent news headlines regarding application vulnerabilities in production applications that have led to security breaches. You want to automatically scan your deployment pipeline for vulnerabilities and ensure only scanned and verified containers can run in the environment. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "312": {
    "q": "A team at your organization collects logs in an on-premises security information and event management system (SIEM). You must provide a subset of Google Cloud logs for the SIEM, and minimize the risk of data exposure in your cloud environment. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "313": {
    "q": "Your Google Cloud organization is subdivided into three folders: production, development, and networking. Networking resources for the organization are centrally managed in the networking folder. You discovered that projects in the production folder are attaching to Shared VPCs that are outside of the networking folder which could become a data exfiltration risk. You must resolve the production folder issue without impacting the development folder. You need to use the most efficient and least disruptive approach. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "314": {
    "q": "Your organization operates in a highly regulated environment and has a stringent set of compliance requirements for protecting customer data. You must encrypt data while in use to meet regulations. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "315": {
  ...
  "316": {
    "q": "You want to set up a secure, internal network within Google Cloud for database servers. The servers must not have any direct communication with the public internet. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "317": {
    "q": "You work for a large organization that recently implemented a 100GB Cloud Interconnect connection between your Google Cloud and your on-premises edge router. While routinely checking the connectivity, you noticed that the connection is operational but there is an error message that indicates MACsec is operationally down. You need to resolve this error. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "318": {
    "q": "Your organization must store highly sensitive data within Google Cloud. You need to design a solution that provides the strongest level of security and control. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "319": {
    "q": "The InfoSec team has mandated that all new Cloud Run jobs and services in production must have Binary Authorization enabled. You need to enforce this requirement. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "320": {
  ...
  "331": {
    "q": "Your organization uses a microservices architecture based on Google Kubernetes Engine (GKE). Recent security reviews recommend tighter controls around deployed container images to reduce potential vulnerabilities and maintain compliance. You need to implement an automated system by using managed services to ensure that only approved container images are deployed to the GKE clusters. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "332": {
    "q": "Your organization has recently migrated sensitive customer data to Cloud Storage buckets. For compliance reasons, you must ensure that all vendor data access and administrative access by Google personnel is logged. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "333": {
    "q": "Your organization is implementing a Zero Trust security model and using Chrome Enterprise Premium. The company is interested in governing access to sensitive data stored in Cloud Storage. You need to configure access controls that ensure only authorized users on managed devices can access this data, regardless of their network location. Access should be restricted based on the device's security posture. This requires up-to-date operating system patches and antivirus software. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "334": {
    "q": "Your organization is using AI to improve products through innovation. The developers want to use Gemini in Vertex AI on a project. You need to provide a secure Google Cloud environment to prevent and detect information leakages. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "335": {
    "q": "You are responsible for configuring Identity and Access Management in your organization's Google Cloud environment. You need to restrict your organization's users from accessing Cloud Storage buckets in other Google Cloud organizations. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "336": {
    "q": "Your organization is storing regulated data in Cloud Storage. Data in Cloud Storage buckets is encrypted by Google-managed encryption keys. To meet compliance requirements, you need to update the existing data to use customer-managed encryption keys instead. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "337": {
    "q": "There is a vendor who needs access to your company's Google Cloud environment. The vendor uses a third-party identity provider (IdP). You need to integrate this IdP with your company's Google Cloud environment to enable single sign-on (SSO) for the vendor's users in the most secure way. You don't want to manage any of the vendor users' lifecycle management. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "338": {
    "q": "Your organization is planning to deploy a large number of Google Kubernetes Engine (GKE) clusters to run business applications in different folders and projects. You must ensure that all GKE nodes always run the latest release to minimize vulnerability risk and administrative effort. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "339": {
  ...
  "354": {
    "q": "Your global defense company is migrating top-secret classified data to BigQuery and Cloud Storage. National security regulations demand that master encryption key material never leaves the accredited on-premises cryptographic hardware. You must retain the unilateral ability to revoke data access, independent of any cloud provider. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "355": {
    "q": "You work at a company in a regulated industry and are responsible for ongoing security of the Cloud environment. You need to prevent and detect misconfigurations in a particular folder based on specific compliance policies. You need to adhere to industry-specific compliance policies and policies that are internal to your company. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "356": {
    "q": "Your organization is using Google Workspace, Google Cloud, and a third-party SIEM. You need to export events such as user logins, successful logins, and failed logins to the SIEM. Logs need to be ingested in real time or near real-time. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "357": {
    "q": "Your company is developing a new application for your organization. The application consists of two Cloud Run services, service A and service B. Service A provides a web-based user frontend. Service B provides backend services that are called by service A. You need to set up Identity and Access Management for the application. Your solution should follow the principle of least privilege. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "358": {
    "q": "Your organization has established a highly sensitive project within a VPC Service Controls perimeter. You need to ensure that only users meeting specific contextual requirements such as having a company-managed device, a specific location, and a valid user identity can access resources within this perimeter. You want to evaluate the impact of this change without blocking legitimate access. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "359": {
    "q": "Your company's storage team manages all product images within a specific Google Cloud project. To maintain control, you must isolate access to Cloud Storage for this project, allowing the storage team to manage restrictions at the project level. They must be restricted to using corporate computers. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "360": {
    "q": "Your organization uses Google Workspace as the primary identity provider for Google Cloud. Users in your organization initially created their passwords. You need to improve password security due to a recent security event. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  },
  "361": {
    "q": "Your company has deployed an artificial intelligence model in a central project. This model contains sensitive intellectual property and must be kept strictly isolated from the internet. You must expose the model endpoint only to a defined list of projects in your organization. What should you do?",
    "about": "Wyjaśnienie zostanie wygenerowane na podstawie treści pytania.",
    "interpret": "Analiza klucza i pułapki pytania zostanie wygenerowana."
  }
};